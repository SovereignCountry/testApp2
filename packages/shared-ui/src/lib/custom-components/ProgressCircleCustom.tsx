...
type CircularWithValueLabelType = {
  progress: number;
  setProgress: React.Dispatch<React.SetStateAction<number>>;
  size: number;
};

type ProgressCircleCustomType = CircularProgressProps & {
  value: number;
  size: number;
};

function CircularWithValueLabel(props: ProgressCircleCustomType) {
  return (
...
export default function ProgressCircleCustom(props: CircularWithValueLabelType) {
